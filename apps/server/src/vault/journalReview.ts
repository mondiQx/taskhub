...
function insertUnderHeading(body: string, heading: string, line: string): string {
...
async function appendUnderHeadingInFile(absPath: string, heading: string, text: string): Promise<void> {
